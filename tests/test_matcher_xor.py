...
def test_true_xor_false_equals_true(rf):
...
def test_false_xor_true_equals_true(rf):
...
def test_true_xor_true_equals_false(rf):
...
def test_false_xor_false_equals_false(rf):
